export const defaultConfig = {
  ...
  buildings: {
    ...
    rowDepthMax: 20,
    houseAreaTarget: 140,
    maxAttemptsPerBlock: 320,
    monoblockMinArea: 900,
    monoblockFillMin: 0.7,
    monoblockFillMax: 0.9,
    trapezoidChance: 0.08,
    coverageTarget: 0.86,
    coverageMinAfterAttempts: 0.6,
    roadBufferCells: 0,
    roadBufferExtra: 1,
    frontageDepthCells: 0,
    belgianBandDepth: 10,
    belgianBandMinRatio: 0.05,
    denseWidthMin: 5,
    denseWidthMax: 9,
    denseDepthMin: 7,
    denseDepthMax: 12,
    denseFrontageRelax: 2,
    farmEdgeBand: 8,
    farmMinArea: 900,
    farmPlotWidthMin: 6,
    farmPlotWidthMax: 26,
    farmPlotHeightMin: 8,
    farmPlotHeightMax: 32,
    farmCoverageTarget: 0.92,
  },
};

export const buildingPresets = {
  standard: { ...defaultConfig.buildings, style: "standard" },
  belgian: {
    ...
    denseFrontageRelax: 2,
    roadBufferExtra: 2,
    frontageDepthCells: 8,
    belgianBandDepth: 10,
    belgianBandMinRatio: 0.05,
    smallLotArea: 196,
    monoblockMinArea: 1200,
  },
};
